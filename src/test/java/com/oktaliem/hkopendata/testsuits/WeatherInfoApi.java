 ...
 * mvn clean verify -Dit.test=com.oktaliem.hkopendata.testsuits.WeatherInfoApi -Dskip-test=true
 */
...
public class WeatherInfoApi {
    ...
    public void testcase_01() {
        ...
        user.verifyWeatherInfoIsCorrect(response, FLW, EN);
    }
    ...
    public void testcase_03() {
        ...
        user.verifyWeatherInfoIsCorrect(response, FLW, SC);
    }
    ...
    public void testcase_04() {
        ...
        user.verifyWeatherInfoIsCorrect(response, FND, EN);
    }
    ...
    public void testcase_05() {
        ...
        user.verifyWeatherInfoIsCorrect(response, FND, TC);
    }
    ...
    public void testcase_06() {
        ...
        user.verifyWeatherInfoIsCorrect(response, FND, SC);
    }
    ...
    public void testcase_10() {
        ...
        user.verifyWeatherInfoIsCorrect(response, WWS, SC);
    }
    ...
    public void testcase_11() {
        ...
        user.verifyWeatherInfoIsCorrect(response, WWS, TC);
    }
    ...
    public void testcase_13() {
        ...
        user.verifyWeatherInfoIsCorrect(response, WNI, EN);
    }
    ...
    public void testcase_14() {
        ...
        user.verifyWeatherInfoIsCorrect(response, WNI, TC);
    }
    ...
    public void testcase_15() {
        ...
        user.verifyWeatherInfoIsCorrect(response, WNI, SC);
    }
    ...
    public void testcase_16() {
        ...
        user.verifyWeatherInfoIsCorrect(response, SWT, EN);
    }
    ...
    public void testcase_17() {
        ...
        user.verifyWeatherInfoIsCorrect(response, SWT, TC);
    }
    ...
    public void testcase_18() {
        ...
        user.verifyWeatherInfoIsCorrect(response, SWT, SC);
    }
}
